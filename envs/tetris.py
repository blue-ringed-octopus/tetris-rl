...
class TetrisEnv(gym.Env):
    ...
    def _get_reward(self):
        ...
        # if self.state.lost:
        #     reward=-9000
        # elif self.cleared_current_turn:
        #     reward=self.cleared_current_turn*100
        # else:
        #     # holes=[sum(self.state.field[0:top, i]==0) for i,top in enumerate(self.state.top)]
            
        #     reward=1#00-max(self.state.top)+1000*self.cleared_current_turn-sum(holes)-np.std(self.state.top)
        reward=0
        return reward
